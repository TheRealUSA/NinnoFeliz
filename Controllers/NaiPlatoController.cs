...
namespace NinnoFeliz.Controllers
{
    public class NaiPlatoController : Controller
    {
        ...
        public NaiPlatoController(NinnoFelizContext context)
        {
            _context = context;
        }
        ...
        {
            var ninnoFelizContext = _context.NaiPlatos.Include(n => n.IdNinnoAlergiaIngredienteNavigation).Include(n => n.IdPlatoNavigation);
