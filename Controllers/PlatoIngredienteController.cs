...
namespace NinnoFeliz.Controllers
{
    public class PlatoIngredienteController : Controller
    {
        ...
        public PlatoIngredienteController(NinnoFelizContext context)
        {
            _context = context;
        }
        ...
        {
            var ninnoFelizContext = _context.PlatoIngredientes.Include(p => p.IdIngredienteNavigation).Include(p => p.IdPlatoNavigation);
